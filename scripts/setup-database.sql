...
-- Create Users table (matching your provided schema)
...
-- Create Feedback table (matching your provided schema with enhancements)
...
-- Insert sample student users (password: StudentPass123)
